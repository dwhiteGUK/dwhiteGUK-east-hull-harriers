...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/groups/162339058586/',
      icon: (props) => (
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/ehh1893',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-base text-white">
              Hull's premier road racing club.
            </p>
        ...
        <div className="mt-12 border-t border-gray-100 pt-8">
          <p className="text-base text-white xl:text-center">
            &copy; {new Date().getFullYear()} East Hull Harriers & A.C. All
            rights reserved.
          </p>
        </div>
      </div>
